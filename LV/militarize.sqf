...
_blueMenArray = ["B_G_Soldier_TL_F","B_G_Soldier_AR_F","B_G_medic_F","B_G_engineer_F","B_G_Soldier_exp_F","B_G_Soldier_GL_F","B_G_Soldier_F","B_G_Soldier_F","B_G_Soldier_F","B_G_Soldier_F"];
//_redMenArray = ["O_SD_Soldier","O_SD_Soldier","O_SD_Soldier_SL","O_SD_Soldier_AT","O_SD_Soldier","O_SD_Soldier","O_SD_Soldier","O_SD_Soldier","O_SD_Soldier_SL"];
_redMenArray = ["CAF_AG_ME_T_AK47","CAF_AG_ME_T_AK74","CAF_AG_ME_T_GL","CAF_AG_ME_T_PKM","CAF_AG_ME_T_RPG","CAF_AG_ME_T_RPK74","CAF_AG_ME_T_SVD"];
...
_greenMenArray = ["rhs_g_Soldier_AR_F","rhs_g_medic_F","rhs_g_Soldier_GL_F","rhs_g_Soldier_F","rhs_g_Soldier_lite_F","rhs_g_Soldier_SL_F","rhs_g_Soldier_TL_F"];

_yellowMenArray = ["RDS_Citizen2","RDS_Citizen1","RDS_Citizen3","RDS_Citizen4","RDS_Functionary1","RDS_Functionary2","RDS_Profiteer2","RDS_Profiteer1","RDS_Profiteer3","RDS_Profiteer4","RDS_Villager1","RDS_Villager2","RDS_Villager3","RDS_Villager4","RDS_Woodlander1","RDS_Woodlander2","RDS_Woodlander3","RDS_Woodlander4","RDS_Worker3","RDS_Worker2","RDS_Worker1","RDS_Worker4"];
...
_yellowCarArray = ["RDS_Octavia_Civ_01","RDS_Hatchback_01_F","RDS_SUV_01_F","RDS_Gaz24_Civ_02","RDS_Gaz24_Civ_03","RDS_Gaz24_Civ_01","RDS_Van_01_transport_F","RDS_Lada_Civ_02","RDS_Lada_Civ_01","RDS_Lada_Civ_03","RDS_Lada_Civ_04"];
