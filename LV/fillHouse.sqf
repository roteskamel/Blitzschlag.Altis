...
_redMenArray3 = ["CAF_AG_ME_T_AK47","CAF_AG_ME_T_AK74","CAF_AG_ME_T_GL","CAF_AG_ME_T_PKM","CAF_AG_ME_T_RPG","CAF_AG_ME_T_RPK74","CAF_AG_ME_T_SVD"];

_OPFarrays = [_redMenArray3]; //[_redMenArray,_redMenArray2];
...
_greenMenArray = ["CAF_AG_EEUR_RI_AK74","CAF_AG_EEUR_RI_AK47","CAF_AG_EEUR_RI_AK47","CAF_AG_EEUR_RI_GL","CAF_AG_EEUR_RI_LAT","CAF_AG_EEUR_RI_PKM","CAF_AG_EEUR_RI_RPK74","CAF_AG_EEUR_RI_RPK74","CAF_AG_EEUR_RI_SVD"];
