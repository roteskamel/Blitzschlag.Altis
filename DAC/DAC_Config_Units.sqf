...
// Civilians (Civilians)
  case 3:
  {
    _Unit_Pool_S = ["RDS_Citizen2","RDS_Citizen2","RDS_Citizen2","RDS_Citizen1","RDS_Citizen3","RDS_Citizen4","RDS_Functionary1","RDS_Functionary2","RDS_Profiteer2","RDS_Profiteer1","RDS_Profiteer3","RDS_Profiteer4","RDS_Villager1","RDS_Villager2","RDS_Villager3","RDS_Villager4","RDS_Woodlander1","RDS_Woodlander2","RDS_Woodlander3","RDS_Woodlander4","RDS_Worker3","RDS_Worker2","RDS_Worker1","RDS_Worker4"];
    _Unit_Pool_V = ["RDS_Octavia_Civ_01","RDS_Hatchback_01_F","RDS_SUV_01_F","RDS_Gaz24_Civ_02","RDS_Gaz24_Civ_03","RDS_Gaz24_Civ_01","RDS_Van_01_transport_F","RDS_Lada_Civ_02","RDS_Lada_Civ_01","RDS_Lada_Civ_03","RDS_Lada_Civ_04"];
    _Unit_Pool_T = [];
    _Unit_Pool_A = [];
  };
//-------------------------------------------------------------------------------------------------
  // Independent (Agressors)
  case 4:
  {
    _Unit_Pool_S = ["I_crew_F","I_helipilot_F","CAF_AG_EEUR_RI_AK74","CAF_AG_EEUR_RI_AK47","CAF_AG_EEUR_RI_AK47","CAF_AG_EEUR_RI_GL","CAF_AG_EEUR_RI_LAT","CAF_AG_EEUR_RI_PKM","CAF_AG_EEUR_RI_RPK74","CAF_AG_EEUR_RI_RPK74","CAF_AG_EEUR_RI_SVD"];
    _Unit_Pool_V = ["CAF_AG_EEUR_RI_Offroad_armed_01"];
    _Unit_Pool_T = [];
    _Unit_Pool_A = [];
  };
//-------------------------------------------------------------------------------------------------
